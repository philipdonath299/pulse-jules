...
import { Settings as SettingsIcon, Bell, Shield, HelpCircle, ChevronRight, LogOut } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const menuItems = [
    ...
    { icon: HelpCircle, label: "Support", color: "text-ios-blue" },
  ]
    ...
    <div className="p-6 space-y-8 pb-32">
      <header className="pt-12 flex flex-col items-center text-center space-y-4">
        <div className="relative">
          ...
          <button className="absolute bottom-0 right-0 bg-ios-blue text-white p-2 rounded-full shadow-lg">
      ...
      <div className="flex gap-4">
        <Card className="flex-1 text-center py-4">
